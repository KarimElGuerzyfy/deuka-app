...
export default function Learning() {
  ...
  return (
    <main className="flex-1 flex px-4 py-6 sm:px-10 lg:py-12 overflow-y-auto justify-center items-center bg-app-bg">
      <div className="flex flex-col w-full max-w-7xl mx-auto rounded-2xl border border-black/5 bg-white p-6 pb-12 sm:p-12 sm:pb-16 lg:p-20 shadow-sm h-fit my-auto">
        <div className="flex flex-col w-full max-w-4xl mx-auto">
          ...
          <button
            ...
            className={`shadow-deuka mt-10 mb-2 w-full max-w-xs mx-auto flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold text-sm transition-all active:scale-95
              ${allWordsSeen
